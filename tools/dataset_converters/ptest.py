...
def parse_args():
    ...
    parser.add_argument('--img_path', help='The root path of images',default="/data/yrguan/CVlab/dataset/images")  # 修改为测试的文件夹
    parser.add_argument(
        '--classes', type=str, help='The text file name of storage class list',default="/data/yrguan/CVlab/dataset/classes.txt")
    parser.add_argument(
        '--out',
        type=str,
        help='The output annotation json file name, The save dir is in the '
        'same directory as img_path',default="test.json")
    parser.add_argument(
        '-e',
        '--exclude-extensions',
        type=str,
